package com.startsoft.gocareerapi.iam.infrastructure.authorization.sfs.configuration;

import com.startsoft.gocareerapi.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(request -> {
            ...
            corsConfig.setAllowedOrigins(Arrays.asList("https://go-career.web.app", "http://localhost:4200"));
